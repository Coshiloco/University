...
namespace UiniversityApiBackend.Controllers
{
    ...
    public class ChaptersController : ControllerBase
    {
        ...
        // GET: api/Chapters
        [HttpGet]
        public async Task<ActionResult<IEnumerable<Chapters>>> GetIndexs()
        {
          if (_context.Indexs == null)
          {
              return NotFound();
          }
            return await _context.Indexs.ToListAsync();
        }
        ...
        public async Task<ActionResult<Chapters>> GetChapters(int id)
        {
          if (_context.Indexs == null)
          {
            ...
            var chapters = await _context.Indexs.FindAsync(id);
        ...
        public async Task<ActionResult<Chapters>> PostChapters(Chapters chapters)
        {
          if (_context.Indexs == null)
          {
              return Problem("Entity set 'UniversityDBContext.Indexs'  is null.");
          }
            _context.Indexs.Add(chapters);
            await _context.SaveChangesAsync();
        ...
        public async Task<IActionResult> DeleteChapters(int id)
        {
            ...
            _context.Indexs.Remove(chapters);
            await _context.SaveChangesAsync();
        ...
        {
            return (_context.Indexs?.Any(e => e.Id == id)).GetValueOrDefault();
        }
    }
}
